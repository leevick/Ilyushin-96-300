...
MSFS_CALLBACK bool Attitude_gauge_callback(FsContext ctx, int service_id, void *pData) {
    ...
    case PANEL_SERVICE_PRE_INSTALL: {
        ...
        g_AttitudeVars.m_eAttitudeIndicatorPitchDegrees = get_aircraft_var_enum("PLANE PITCH DEGREES");
        g_AttitudeVars.m_eAttitudeIndicatorBankDegrees = get_aircraft_var_enum("PLANE BANK DEGREES");
        return true;
    } break;
