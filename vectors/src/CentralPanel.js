                            ...
                            }
                            {
                                Array.from({ length: 3 }, (_, i) => {
                                    return [<line stroke="white" strokeWidth={8}
                                        ...
                                        y2={40} />,
                                    <g transform="rotate(-90)">
                                        <text x={5} y={-Math.PI / 180 * 5 * 330 + Math.PI / 180 * 20 * 330 * i} fill="white" fontSize={40} letterSpacing={i === 2 ? -5 : 0} textLength={i === 2 ? 30 : 20} lengthAdjust="spacingAndGlyphs" fontFamily="lenya69">{`${i * 4 + 4}`}</text>
                                    </g>]
                                })
                            }

                            {
                                Array.from({ length: 2 }, (_, i) => {
                                    return <g transform="rotate(-90)">
                                        <text x={5} y={-Math.PI / 180 * 35 * 330 + Math.PI / 180 * 10 * 330 * i + 20} fill="white" fontSize={40} letterSpacing={i === 2 ? -5 : 0} textLength={i === 2 ? 30 : 20} lengthAdjust="spacingAndGlyphs" fontFamily="lenya69">{`${(1 - i) * 2}`}</text>
                                    </g>
                                })
                            }
